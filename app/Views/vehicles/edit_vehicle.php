...
<div class="wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          <form method="post" action="<?= base_url() ?>/Vehicle/Insert_vehicle" enctype="multipart/form-data">
          <div class="row">
          <!-- left column -->
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                <div class="card-body">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title"><b>Vehicle Detail</b></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number"  class="form-control form-control-sm"  placeholder="Plate No." required>
                                        </div>
                                        <div class="form-group">
                                            <label>Vehicle Type<span style="color: red">*</span></label>
                                            <input type="text" name="type"  class="form-control form-control-sm"  placeholder="Vehicle Type" required>
                                        </div>
                                    </div>
                ...
                <div class="card-footer col-md-12">
                    <div class="">
                        <button type="button" onclick="window.location.href='<?php echo base_url(); ?>/Customer'" class="btn btn-default">Cancel</button>
