...
<div class="wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid" >
                <div class="row mb-2" style="border-bottom: 1px solid #888da8;">
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="">Captain</a></li>
                        </ol>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    </div><!-- /.col -->
                ...
                <div class="row mb-2" style="border-bottom: 1px solid #888da8; padding-bottom: 10px;">
                    <div class="col-6">
                        <h5 style="padding-top: 3px;" class="m-0">Captain</h5>
                    </div><!-- /.col -->
                    <div class="col-6">
                        ...
                        <div class="float-right" style="margin-right: 10px;">
                            ...
                            <div class="dropdown-menu mm1">
                                <a class="dropdown-item" href="<?= base_url(); ?>/Captain/Add_captain">Captain</a>
                            </div>
                        </div>
    ...
    <script>
            ...
            $('#delete').on('click', function(e){
                ...
                if($('#myTable input[type="checkbox"]:checked').length)
                {
                    ...
                    $.ajax({
                        type: "POST",
                        url:"<?= base_url(); ?>/Captain/deleteSelected",
                        data:
                            {
                                string:string
                            },
    ...
    <script type="text/javascript">
        table = $('#myTable').DataTable({
            ...
            "serverSide" : true,
            "ajax" : {
                "url" : "<?php echo site_url('/Captain/show'); ?>",
                "type" : "POST"
            },
            'columnDefs': [
                {
        ...
        function delone(string)
        {
            ...
            $.ajax({
                type: "POST",
                url:"<?= base_url(); ?>/Captain/deleteone",
                data:
                    {
                        string:string
                    },
