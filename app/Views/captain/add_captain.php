...
<div class="wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          <form method="post" action="<?= base_url() ?>/Captain/Insert_captain" enctype="multipart/form-data">
          <div class="row">
          <!-- left column -->
          <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="joindate"  class="form-control form-control-sm"  placeholder="Date" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Captain Name <span style="color: red">*</span></label>
                                            <input type="text" name="name"  class="form-control form-control-sm"  placeholder="Captain Name" required>
                                        </div>
                                        <div class="form-group">
